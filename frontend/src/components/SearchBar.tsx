...
const SearchBar = ({setSearch}:{setSearch:React.Dispatch<React.SetStateAction<string>>}) => {
  ...
  return (
    ...
    <div className="relative">
        ...
        <input type="text" id="default-search" onChange={(e)=>setSearch(e.target.value)} className="shadow-md border outline-none sm:w-80 p-3 text-sm text-gray-900 rounded-full" placeholder="Search" required />
